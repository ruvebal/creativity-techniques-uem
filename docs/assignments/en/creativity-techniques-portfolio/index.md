...
# Final Portfolio Notebook

**Creativity Techniques · final assignment · publishable now so you can build it from the first lab**
...
Start the notebook in the first class and update it every time Lab begins. A complete Lab entry can be short; it must be specific.

| Moment | What to record | Minimum evidence |
| --- | --- | --- |
| **Opening** | Date, exercise title, brief, constraint, and intention | 3–5 lines or a marked-up brief |
| **Making** | Sketches, lists, tests, versions, references, or working files | At least two traces, including one imperfect or discarded route |
| **Exchange** | A peer/professor observation or your own critical question | One quoted/paraphrased comment and your response |
...
Bring or upload the final notebook using the format agreed in the Campus Virtual. Be ready to point to one entry that changed your direction and explain what the portfolio proves about your way of working. The professor may ask about any trace, including a discarded one.

## References and course grounding

The brief is anchored in the official subject guide's presentation, contents, competencies, learning outcomes, formative activities, and evaluation categories. The process emphasis is also consistent with reflective studio practice: learning is made visible through the relationship between action, observation, revision, and explanation. This is a course design frame, not a claim that one model explains every creative process.
